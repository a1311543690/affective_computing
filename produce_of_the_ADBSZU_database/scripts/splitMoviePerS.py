...
def cutMovie(moviePath, startSecond, endSecond, outputPath):
    ...
    commandLine = 'ffmpeg -loglevel error -i "' + moviePath + '" -ss ' + str(startSecond) + ' -to ' + str(endSecond) + ' -acodec copy -vcodec copy "' + outputPath + '"'
    ...
    for movie in movieNames:
        ...
        if(os.path.isfile(moviePath)):
            ...
            for idx in range(len(videoTime)-1):
                ...
                outputPath = outputFolder + movie[:-4] + '_' + charName + str(idx) + movieFormat
