...
if __name__ == '__main__':
    ...
    for moviePath in moviePaths:
        ...
        if(os.path.isfile(moviePath)):
            ...
            totalTimes=totalTimes+movieTotalSeconds
            f.write(moviePath+'\t'+str(movieTotalSeconds)+'\n')
        else:
           print('ERROR: file ' + moviePath + ' does not exist')
    f.write('-------------------------------------------------------------------------------------\n')
    f.write('the total times is'+str(totalTimes)+'s'+'\tor\t'+str(timedelta(seconds=totalTimes)))
    f.close()
